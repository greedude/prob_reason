...
% paint the graph for 2 secs    
   if ignored
        ...
        DrawFormattedText(w, str_graph, 'center', height*2/3+50,WhiteIndex(curScreen));
...
%     str2=double(sprintf('\n\n\n     \n\n 总分%.2f \n',totalScore));
    str_score=double(sprintf('%.2f',curScore));
